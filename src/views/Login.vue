<template>
	<div
		class="min-h-screen flex items-center justify-center bg-gradient-to-b from-blue-50 to-gray-100"
	>
		<div
			class="bg-white p-8 rounded-xl shadow-lg w-full max-w-md border border-gray-100 transition-all duration-300 hover:shadow-xl"
		>
			<h2 class="text-2xl font-bold text-center text-gray-800 mb-8">
				<span
					class="bg-clip-text text-transparent bg-gradient-to-r from-blue-500 to-indigo-600"
					>登入 / 註冊</span
				>
			</h2>
			...
			<p class="text-sm text-center text-gray-600 mt-6">
				...
				<button
					@click="toggleMode"
					class="text-blue-600 hover:text-blue-800 font-medium hover:underline ml-1 transition-colors duration-200"
				>
					{{ isLogin ? "註冊帳號" : "去登入" }}
				</button>
			</p>
