  ...
  <div class="bg-white p-6 rounded-xl shadow-md w-full sticky top-4">
    ...
    <form @submit.prevent="submitPost">
      <textarea
        ...
        placeholder="寫點什麼吧..."
        rows="6"
        class="w-full p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 resize-none text-gray-800 transition-all duration-200"></textarea>
